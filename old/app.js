angular.module('bopFinder', ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'spotify'])
    ...
    .controller('MainCtrl', ['$scope', '$http', '$window', 'Spotify', MainCtrl]);


    function MainCtrl($scope, $http, $window, Spotify)
{
